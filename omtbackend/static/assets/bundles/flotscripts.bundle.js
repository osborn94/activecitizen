  ...
  (r.color = {}),
    ...
    (r.color.parse = function (e) {
      ...
      if (
        ...
        return i(parseInt(t[1], 10), parseInt(t[2], 10), parseInt(t[3], 10));
      if (
        (t =
      ...
      if ((t = /#([a-fA-F0-9]{2})([a-fA-F0-9]{2})([a-fA-F0-9]{2})/.exec(e)))
        return i(parseInt(t[1], 16), parseInt(t[2], 16), parseInt(t[3], 16));
    ...
    function n(m, e, t, n) {
        ...
        (S = (function (e) {
          ...
          (function () {
            ...
            var o,
              ...
              s = 0;
            for (e = 0; e < t; e++)
              (o = Q.color.parse(a[e % l] || '#666')),
                e % l == 0 && e && (s = 0 <= s ? (s < 0.5 ? -s - 0.2 : 0) : -s),
                (r[e] = o.scale('rgb', 1 + s));
            var c,
              h = 0;
            for (e = 0; e < S.length; ++e) {
          ...
          (function () {
            ...
            for (
              ...
              ((o = S[e]).datapoints = { points: [] }),
                W(C.processRawData, [o, o.data, o.datapoints]);
            for (e = 0; e < S.length; ++e) {
              if (((o = S[e]), (h = o.data), !(u = o.datapoints.format))) {
                if (
                  ((u = []).push({ x: !0, number: !0, required: !0 }),
                  u.push({ y: !0, number: !0, required: !0 }),
                  ...
                  u.push({
                    ...
                    o.bars.horizontal &&
                      (delete u[u.length - 1].y, (u[u.length - 1].x = !0));
                }
                o.datapoints.format = u;
              }
              if (null == o.datapoints.pointsize) {
                (o.datapoints.pointsize = u.length),
                  (a = o.datapoints.pointsize),
                  (r = o.datapoints.points);
                var x = o.lines.show && o.lines.steps;
                for (
                  o.xaxis.used = o.yaxis.used = !0, t = i = 0;
                  t < h.length;
                  ++t, i += a
                ) {
                  var v = null == (c = h[t]);
                  ...
                  if (v)
                    for (n = 0; n < a; ++n)
                      null != (l = r[i + n]) &&
                        !1 !== (s = u[n]).autoscale &&
                        (s.x && g(o.xaxis, l, l), s.y && g(o.yaxis, l, l)),
                        (r[i + n] = null);
                  else if (
                    x &&
                    0 < i &&
            ...
            for (e = 0; e < S.length; ++e)
              (o = S[e]), W(C.processDatapoints, [o, o.datapoints]);
            for (e = 0; e < S.length; ++e) {
              (o = S[e]),
                (r = o.datapoints.points),
                (a = o.datapoints.pointsize),
                (u = o.datapoints.format);
              var b = f,
                k = f,
                y = d,
                w = d;
      ...
      function u(e) {
        ...
        for (t = 0; t < p.length; ++t)
          (i = p[t]) && i.used && (n['x' + i.n] = i.c2p(e.left));
        for (t = 0; t < g.length; ++t)
          (i = g[t]) && i.used && (n['y' + i.n] = i.c2p(e.top));
        return (
      ...
      function r() {
        N && clearTimeout(N),
          h.unbind('mousemove', q),
          h.unbind('mouseleave', O),
          h.unbind('click', R),
          W(C.shutdown, [h]);
      }
      function a(i) {
        ...
        Q.each(o ? p : g, function (e, t) {
          t &&
            ...
            (t === i
              ? (u = !0)
              : t.options.position === n && (u ? (c = !1) : (s = !1)),
            u || (h = !1));
        }),
          c && (a = 0),
          null == r && (r = h ? 'full' : 5),
          ...
          o
            ? ((t += l),
              'bottom' == n
                ? ((w.bottom += t + a),
                  (i.box = { top: d.height - w.bottom, height: t }))
                : ((i.box = { top: w.top + a, height: t }), (w.top += t + a)))
            : ((e += l),
              'left' == n
                ? ((i.box = { left: w.left + a, width: e }), (w.left += e + a))
                : ((w.right += e + a),
                  (i.box = { left: d.width - w.right, width: e }))),
          (i.position = n),
          (i.tickLength = r),
          (i.box.padding = l),
          (i.innermost = s);
      ...
      function l() {
        ...
        for (var n in (W(C.processOffset, [w]), w))
          'object' == typeof z.grid.borderWidth
            ? (w[n] += i ? z.grid.borderWidth[n] : 0)
            : (w[n] += i ? z.grid.borderWidth : 0);
        if (
            ...
            Q.each(r, function (e, t) {
              ...
              !(function (e) {
                var t,
                  i = e.options;
                t =
                  'number' == typeof i.ticks && 0 < i.ticks
                    ? i.ticks
                    : 0.3 * Math.sqrt('x' == e.direction ? d.width : d.height);
                var n = (e.max - e.min) / t,
                ...
                if (
                  ((e.delta = n),
                  (e.tickDecimals = Math.max(0, null != r ? r : o)),
                  ...
                  ((e.tickGenerator = function (e) {
                    for (
                      var t,
                        ...
                        n,
                        o = [],
                        r = ((i = e.min), (n = e.tickSize) * Math.floor(i / n)),
                        a = 0,
                        l = Number.NaN;
                      (t = l),
                        (l = r + a * e.tickSize),
                ...
                Q.isFunction(i.tickFormatter) &&
                  (e.tickFormatter = function (e, t) {
                    return '' + i.tickFormatter(e, t);
                  });
                if (null != i.alignTicksWithAxis) {
                  var c = ('x' == e.direction ? p : g)[
                    i.alignTicksWithAxis - 1
                  ];
                  if (c && c.used && c != e) {
                    var h = e.tickGenerator(e);
                    if (
                      (0 < h.length &&
                        (null == i.min && (e.min = Math.min(e.min, h[0])),
                        null == i.max &&
                          1 < h.length &&
                          (e.max = Math.max(e.max, h[h.length - 1]))),
                      (e.tickGenerator = function (e) {
                        var t,
                          i,
                          n = [];
                        for (i = 0; i < c.ticks.length; ++i)
                          (t = (c.ticks[i].v - c.min) / (c.max - c.min)),
                      ...
                      var u = Math.max(
                          0,
                          1 - Math.floor(Math.log(e.delta) / Math.LN10)
                        ),
                        f = e.tickGenerator(e);
                      (1 < f.length &&
                        /\..*0$/.test((f[1] - f[0]).toFixed(u))) ||
                        (e.tickDecimals = u);
                    }
                  }
                }
                ...
                (function (e) {
                  ...
                  null == n || ('number' == typeof n && 0 < n)
                    ? (o = e.tickGenerator(e))
                    : n && (o = Q.isFunction(n) ? n(e) : n);
                  for (e.ticks = [], t = 0; t < o.length; ++t) {
                    var r = null,
                      a = o[t];
                    'object' == typeof a
                      ? ((i = +a[0]), 1 < a.length && (r = a[1]))
                      : (i = +a),
                      null == r && (r = e.tickFormatter(i, e)),
                      isNaN(i) || e.ticks.push({ v: i, label: r });
                  }
                })(t),
                (n = (i = t).ticks),
                i.options.autoscaleMargin &&
                  0 < n.length &&
                  (null == i.options.min && (i.min = Math.min(i.min, n[0].v)),
                  null == i.options.max &&
                    1 < n.length &&
                    (i.max = Math.max(i.max, n[n.length - 1].v))),
                (function (e) {
                  for (
                    var t = e.options,
                      i = e.ticks || [],
                      ...
                      l =
                        ...
                        '-axis ' +
                        a,
                      s = t.font || 'flot-tick-label tickLabel',
                      c = 0;
                    c < i.length;
                    ++c
                  ) {
          ...
          !(function () {
            ...
            if (null == t)
              for (e = t = 0; e < S.length; ++e)
                t = Math.max(
                  t,
                  2 * (S[e].points.radius + S[e].points.lineWidth / 2)
                );
            ...
            Q.each(I(), function (e, t) {
              ...
              (w.left = Math.ceil(Math.max(i.left, w.left))),
              (w.right = Math.ceil(Math.max(i.right, w.right))),
              (w.top = Math.ceil(Math.max(i.top, w.top))),
              (w.bottom = Math.ceil(Math.max(i.bottom, w.bottom)));
          })(),
            Q.each(r, function (e, t) {
              var i;
              'x' == (i = t).direction
                ? ((i.box.left = w.left - i.labelWidth / 2),
                  (i.box.width = d.width - w.left - w.right + i.labelWidth))
                : ((i.box.top = w.top - i.labelHeight / 2),
                  (i.box.height = d.height - w.bottom - w.top + i.labelHeight));
            });
        }
        (M = d.width - w.left - w.right),
          (T = d.height - w.bottom - w.top),
          Q.each(t, function (e, t) {
            !(function (e) {
              function t(e) {
                return e;
              ...
              'x' == e.direction
                ? ((i = e.scale = M / Math.abs(o(e.max) - o(e.min))),
                  (n = Math.min(o(e.max), o(e.min))))
                : ((i = -(i = e.scale = T / Math.abs(o(e.max) - o(e.min)))),
                  (n = Math.max(o(e.max), o(e.min)))),
                (e.p2c =
                  o == t
                    ? function (e) {
                        return (e - n) * i;
                  ...
                  !(i = t.ticks[u]).label ||
                    ...
                    ('x' == t.direction
                      ? ((r = 'center'),
                        ...
                        'bottom' == t.position
                          ? (o = l.top + l.padding)
                          : ((o = l.top + l.height - l.padding),
                            (a = 'bottom')))
                      : ((a = 'middle'),
                        (o = w.top + t.p2c(i.v)),
                        'left' == t.position
                          ? ((n = l.left + l.width - l.padding), (r = 'right'))
                          : (n = l.left + l.padding)),
                    d.addText(c, n, o, i.label, h, null, null, r, a));
            }),
          (function () {
            null != z.legend.container
              ? Q(z.legend.container).html('')
            ...
            for (
              var e,
                ...
                n = [],
                o = !1,
                r = z.legend.labelFormatter,
                a = 0;
              a < S.length;
              ++a
            )
              (e = S[a]).label &&
                (t = r ? r(e.label, e) : e.label) &&
                n.push({ label: t, color: e.color });
            if (z.legend.sorted)
            ...
            for (var a = 0; a < n.length; ++a) {
              var s = n[a];
              a % z.legend.noColumns == 0 &&
                (o && i.push('</tr>'), i.push('<tr>'), (o = !0)),
                i.push(
                  '<td class="legendColorBox"><div style="border:1px solid ' +
                    z.legend.labelBoxBorderColor +
            ...
            if (null != z.legend.container) Q(z.legend.container).html(c);
              ...
              null == f[0] && (f = [f, f]),
                'n' == u.charAt(0)
                  ? (h += 'top:' + (f[1] + w.top) + 'px;')
                  : 's' == u.charAt(0) &&
                    (h += 'bottom:' + (f[1] + w.bottom) + 'px;'),
                'e' == u.charAt(1)
                  ? (h += 'right:' + (f[0] + w.right) + 'px;')
                  : 'w' == u.charAt(1) &&
                    (h += 'left:' + (f[0] + w.left) + 'px;');
              var d = Q(
                '<div class="legend">' +
              ...
              if (0 != z.legend.backgroundOpacity) {
                ...
                null == p &&
                  (((p =
                    (p = z.grid.backgroundColor) && 'string' == typeof p
                      ? Q.color.parse(p)
                      : Q.color.extract(d, 'background-color')).a = 1),
                  (p = p.toString()));
                var g = d.children();
                Q(
                  ...
                  .prependTo(d)
                  .css('opacity', z.legend.backgroundOpacity);
              }
            }
          })();
      }
      function s() {
        ...
        e.show &&
          e.backgroundColor &&
          (y.save(),
          y.translate(w.left, w.top),
          (y.fillStyle = X(
            z.grid.backgroundColor,
            T,
            0,
            'rgba(255, 255, 255, 0)'
          )),
        ...
        if (o)
          for (
            ...
            var r = o[e],
              ...
              l = F(r, 'y');
            if (
              (null == a.from && (a.from = a.axis.min),
              null == a.to && (a.to = a.axis.max),
              ...
              (a.from = Math.max(a.from, a.axis.min)),
                (a.to = Math.min(a.to, a.axis.max)),
              ...
              if (!s || !c)
                if (
                  ((a.from = Math.floor(a.axis.p2c(a.from))),
                  (a.to = Math.floor(a.axis.p2c(a.to))),
                  ...
                  var h = r.lineWidth || z.grid.markingsLineWidth,
                    u = h % 2 ? 0.5 : 0;
                  y.beginPath(),
                    (y.strokeStyle = r.color || z.grid.markingsColor),
                    (y.lineWidth = h),
                    s
                      ? (y.moveTo(a.to + u, l.from), y.lineTo(a.to + u, l.to))
                      : (y.moveTo(a.from, l.to + u), y.lineTo(a.to, l.to + u)),
                    y.stroke();
                } else
                  (y.fillStyle = r.color || z.grid.markingsColor),
                    y.fillRect(a.from, l.to, a.to - a.from, l.from - l.to);
            }
          }
            ...
            for (
                    ...
                    (p =
                      'full' == b
                        ? 'top' == x.position
                          ? 0
                          : T
                        : v.top - w.top + ('top' == x.position ? v.height : 0)))
                  : ((p = 0),
                    (d =
                      'full' == b
                        ? 'left' == x.position
                        ...
                        : v.left -
                          w.left +
                          ('left' == x.position ? v.width : 0))),
                x.innermost ||
                  ((y.strokeStyle = x.options.color),
                  y.beginPath(),
                  (g = m = 0),
                  'x' == x.direction ? (g = M + 1) : (m = T + 1),
                  1 == y.lineWidth &&
                    ('x' == x.direction
                      ? (p = Math.floor(p) + 0.5)
                      : (d = Math.floor(d) + 0.5)),
                  ...
                  y.lineTo(d + g, p + m),
                  y.stroke()),
                y.strokeStyle = x.options.tickColor,
                y.beginPath(),
                e = 0;
              e < x.ticks.length;
              ++e
              ...
              (g = m = 0),
                isNaN(k) ||
                  ...
                  k > x.max ||
                  ('full' == b &&
                    (('object' == typeof i && 0 < i[x.position]) || 0 < i) &&
                    (k == x.min || k == x.max)) ||
                  ('x' == x.direction
                    ? ((d = x.p2c(k)),
                      (m = 'full' == b ? -T : b),
          ...
          'object' == typeof i || 'object' == typeof n
            ? ('object' != typeof i &&
              ...
              0 < i.top &&
                ...
                (y.lineWidth = i.top),
                y.beginPath(),
                y.moveTo(0 - i.left, 0 - i.top / 2),
                y.lineTo(M, 0 - i.top / 2),
                y.stroke()),
              0 < i.right &&
                ((y.strokeStyle = n.right),
                (y.lineWidth = i.right),
                y.beginPath(),
                y.moveTo(M + i.right / 2, 0 - i.top),
                y.lineTo(M + i.right / 2, T),
                y.stroke()),
              0 < i.bottom &&
                ((y.strokeStyle = n.bottom),
                (y.lineWidth = i.bottom),
                y.beginPath(),
                y.moveTo(M + i.right, T + i.bottom / 2),
                y.lineTo(0, T + i.bottom / 2),
                y.stroke()),
              0 < i.left &&
                ((y.strokeStyle = n.left),
                (y.lineWidth = i.left),
                y.beginPath(),
                y.moveTo(0 - i.left / 2, T + i.bottom),
                y.lineTo(0 - i.left / 2, 0),
                y.stroke()))
            : ((y.lineWidth = i),
              (y.strokeStyle = z.grid.borderColor),
              y.strokeRect(-i / 2, -i / 2, M + i, T + i))),
          y.restore();
      }
      function b(e) {
        e.lines.show &&
            ...
            function t(e, t, i, n, o) {
              ...
              for (var c = a; c < r.length; c += a) {
                ...
                if (null != h && null != f) {
                  ...
                  (h == l && u == s) || y.moveTo(n.p2c(h) + t, o.p2c(u) + i),
                    (l = f),
                    (s = d),
                    y.lineTo(n.p2c(f) + t, o.p2c(d) + i);
                }
              }
              y.stroke();
            }
              ...
              (function (e, t, i) {
                ...
                for (; !(0 < o && a > n.length + o); ) {
                  ...
                  if (null != u && null != d) {
                    ...
                    if (
                      (l ||
                        (y.beginPath(), y.moveTo(t.p2c(u), i.p2c(r)), (l = !0)),
                      f >= i.max && p >= i.max)
                    )
                      y.lineTo(t.p2c(u), i.p2c(i.max)),
                        y.lineTo(t.p2c(d), i.p2c(i.max));
                    else if (f <= i.min && p <= i.min)
                      y.lineTo(t.p2c(u), i.p2c(i.min)),
                        y.lineTo(t.p2c(d), i.p2c(i.min));
                    else {
                      var g = u,
                        m = d;
                      f <= p && f < i.min && p >= i.min
                        ...
                        p <= f && f > i.max && p <= i.max
                          ...
                          : f <= p &&
                            ...
                            ((d = ((i.max - f) / (p - f)) * (d - u) + u),
                            (p = i.max)),
                        u != g && y.lineTo(t.p2c(g), i.p2c(f)),
                        y.lineTo(t.p2c(u), i.p2c(f)),
                        y.lineTo(t.p2c(d), i.p2c(p)),
                        d != m &&
                          (y.lineTo(t.p2c(d), i.p2c(p)),
                          y.lineTo(t.p2c(m), i.p2c(p)));
                    }
                  }
                }
          ...
          e.bars.show &&
            (function (c) {
              ...
              (function (e, t, i, n, o, r) {
                for (
                  var a = e.points, l = e.pointsize, s = 0;
                  s < a.length;
                  s += l
                )
                  null != a[s] &&
            ...
            (function (e) {
              function t(e, t, i, n, o, r, a, l) {
                for (
                  ...
                  null == u ||
                    ...
                    (f = a.p2c(f) + n),
                    'circle' == l
                      ? y.arc(u, f, t, 0, o ? Math.PI : 2 * Math.PI, !1)
                      : l(y, u, f, t, o),
                    y.closePath(),
                    i && ((y.fillStyle = i), y.fill()),
                    y.stroke());
                }
              }
              y.save(), y.translate(w.left, w.top);
              ...
              if (0 < i && 0 < n) {
                ...
                (y.lineWidth = a),
                  ...
                  t(e.datapoints, o, null, a + a / 2, !0, e.xaxis, e.yaxis, r),
                  (y.strokeStyle = 'rgba(0,0,0,0.2)'),
                  t(e.datapoints, o, null, a / 2, !0, e.xaxis, e.yaxis, r);
              }
              (y.lineWidth = i),
      ...
      function k(e, t, i, n, o, r, a, l, s, c, h) {
        ...
        c
          ? ((v = m = x = !0),
            ...
            (p = t + n),
            (d = t + o),
            (f = e) < (u = i) && ((b = f), (f = u), (u = b), (m = !(g = !0))))
          : ((g = m = x = !0),
            (v = !1),
            (u = e + n),
            (f = e + o),
            (p = t) < (d = i) && ((b = p), (p = d), (d = b), (x = !(v = !0)))),
          f < a.min ||
            u > a.max ||
            p < l.min ||
            d > l.max ||
            ...
            (f = a.p2c(f)),
            (p = l.p2c(p)),
            r && ((s.fillStyle = r(d, p)), s.fillRect(u, p, f - u, d - p)),
            0 < h &&
              (g || m || x || v) &&
              (s.beginPath(),
              s.moveTo(u, d),
              g ? s.lineTo(u, p) : s.moveTo(u, p),
              x ? s.lineTo(f, p) : s.moveTo(f, p),
              m ? s.lineTo(f, d) : s.moveTo(f, d),
              v ? s.lineTo(u, d) : s.moveTo(u, d),
              s.stroke()));
      }
      function P(e, t, i, n) {
        var o = e.fill;
        ...
        return (
          (r.a = 'number' == typeof o ? o : 0.4), r.normalize(), r.toString()
        );
      }
      (A.setData = o),
        (A.setupGrid = l),
        (A.draw = s),
        (A.getPlaceholder = function () {
          return m;
        }),
        ...
        (A.getAxes = function () {
          var i = {};
          return (
            Q.each(p.concat(g), function (e, t) {
        ...
        (A.highlight = Y),
        (A.unhighlight = E),
        (A.triggerRedrawOverlay = L),
        (A.pointOffset = function (e) {
          return {
        ...
        (A.destroy = function () {
          r(),
            m.removeData('plot').empty(),
            (S = []),
            (p = []),
            (g = []),
            (D = []),
            (A = C = c = y = h = i = d = z = null);
        }),
        (A.resize = function () {
          var e = m.width(),
            t = m.height();
        ...
        (A.hooks = C),
        (function () {
          for (var e = { Canvas: V }, t = 0; t < n.length; ++t) {
            var i = n[t];
        ...
        (function (e) {
          ...
          null == z.xaxis.color &&
            (z.xaxis.color = Q.color
              .parse(z.grid.color)
              .scale('a', 0.22)
              .toString());
          null == z.yaxis.color &&
            (z.yaxis.color = Q.color
              .parse(z.grid.color)
              .scale('a', 0.22)
              .toString());
          null == z.xaxis.tickColor &&
            (z.xaxis.tickColor = z.grid.tickColor || z.xaxis.color);
          null == z.yaxis.tickColor &&
            (z.yaxis.tickColor = z.grid.tickColor || z.yaxis.color);
          null == z.grid.borderColor && (z.grid.borderColor = z.grid.color);
          null == z.grid.tickColor &&
            (z.grid.tickColor = Q.color
              .parse(z.grid.color)
              .scale('a', 0.22)
              .toString());
          var t,
            ...
            a = {
              ...
              size: Math.round(0.8 * r),
              variant: m.css('font-variant'),
              weight: m.css('font-weight'),
              family: m.css('font-family'),
            };
          for (n = z.xaxes.length || 1, t = 0; t < n; ++t)
            (i = z.xaxes[t]) && !i.tickColor && (i.tickColor = i.color),
              (i = Q.extend(!0, {}, z.xaxis, i)),
              (z.xaxes[t] = i).font &&
                ((i.font = Q.extend({}, a, i.font)),
                i.font.color || (i.font.color = i.color),
                i.font.lineHeight ||
                  (i.font.lineHeight = Math.round(1.15 * i.font.size)));
          for (n = z.yaxes.length || 1, t = 0; t < n; ++t)
            (i = z.yaxes[t]) && !i.tickColor && (i.tickColor = i.color),
              (i = Q.extend(!0, {}, z.yaxis, i)),
              (z.yaxes[t] = i).font &&
                ((i.font = Q.extend({}, a, i.font)),
                i.font.color || (i.font.color = i.color),
                i.font.lineHeight ||
          ...
          z.xaxis.noTicks &&
            null == z.xaxis.ticks &&
            (z.xaxis.ticks = z.xaxis.noTicks);
          z.yaxis.noTicks &&
            null == z.yaxis.ticks &&
            (z.yaxis.ticks = z.yaxis.noTicks);
          z.x2axis &&
            ((z.xaxes[1] = Q.extend(!0, {}, z.xaxis, z.x2axis)),
            (z.xaxes[1].position = 'top'),
            null == z.x2axis.min && (z.xaxes[1].min = null),
            null == z.x2axis.max && (z.xaxes[1].max = null));
          z.y2axis &&
            ((z.yaxes[1] = Q.extend(!0, {}, z.yaxis, z.y2axis)),
            (z.yaxes[1].position = 'right'),
            null == z.y2axis.min && (z.yaxes[1].min = null),
            null == z.y2axis.max && (z.yaxes[1].max = null));
          z.grid.coloredAreas && (z.grid.markings = z.grid.coloredAreas);
          z.grid.coloredAreasColor &&
            (z.grid.markingsColor = z.grid.coloredAreasColor);
          ...
          null != z.highlightColor &&
            (z.series.highlightColor = z.highlightColor);
          for (t = 0; t < z.xaxes.length; ++t) v(p, t + 1).options = z.xaxes[t];
          for (t = 0; t < z.yaxes.length; ++t) v(g, t + 1).options = z.yaxes[t];
          for (var l in C)
            z.hooks[l] && z.hooks[l].length && (C[l] = C[l].concat(z.hooks[l]));
        ...
        (function () {
          m
            ...
            .filter(function () {
              return (
                !Q(this).hasClass('flot-overlay') &&
                !Q(this).hasClass('flot-base')
              );
            })
            .remove(),
            'static' == m.css('position') && m.css('position', 'relative');
          (d = new V('flot-base', m)),
            (i = new V('flot-overlay', m)),
            (y = d.context),
            (c = i.context),
            (h = Q(i.element).unbind());
          var e = m.data('plot');
      ...
      function H(e, t, i) {
          ...
          for (n = S.length - 1; 0 <= n; --n)
            if (i(S[n])) {
              var c = S[n],
                ...
                m = a / u.scale;
              if (
                ((r = c.datapoints.pointsize),
                h.options.inverseTransform && (g = Number.MAX_VALUE),
        ...
        if (
          (l &&
            ((l.pageX = parseInt(
              l.series.xaxis.p2c(l.datapoint[0]) + n.left + w.left,
              10
            )),
            (l.pageY = parseInt(
              l.series.yaxis.p2c(l.datapoint[1]) + n.top + w.top,
              10
            ))),
          z.grid.autoHighlight)
        ) {
      ...
      function L() {
        ...
        -1 != e ? N || (N = setTimeout(j, e)) : j();
      }
      function j() {
        var e, t;
        for (
          N = null, c.save(), i.clear(), c.translate(w.left, w.top), e = 0;
          e < D.length;
          ++e
        )
          (t = D[e]).series.bars.show
            ? _(t.series, t.point)
            : G(t.series, t.point);
      ...
      function Y(e, t, i) {
        ...
        var o = B(e, t);
        -1 == o
          ? (D.push({ series: e, point: t, auto: i }), L())
          : i || (D[o].auto = !1);
      }
      function E(e, t) {
      ...
      function B(e, t) {
        for (var i = 0; i < D.length; ++i) {
          var n = D[i];
          if (n.series == e && n.point[0] == t[0] && n.point[1] == t[1])
            return i;
        }
        return -1;
      }
        ...
        var i = t[0],
          ...
          a =
            'string' == typeof e.highlightColor
              ? e.highlightColor
              : Q.color.parse(e.color).scale('a', 0.5).toString();
        if (!(i < o.min || i > o.max || n < r.min || n > r.max)) {
          ...
          (i = o.p2c(i)),
            ...
            'circle' == e.points.symbol
              ? c.arc(i, n, s, 0, 2 * Math.PI, !1)
              : e.points.symbol(c, i, n, s, !1),
            c.closePath(),
            c.stroke();
        }
      }
      ...
      function X(e, t, i, n) {
        ...
        for (
          var o = y.createLinearGradient(0, i, 0, t),
            r = 0,
            a = e.colors.length;
          r < a;
          ++r
    ...
    Q.fn.detach ||
      ...
      (V.prototype.resize = function (e, t) {
        ...
        var i = this.element,
          ...
          o = this.pixelRatio;
        this.width != e &&
          ((i.width = e * o), (i.style.width = e + 'px'), (this.width = e)),
          this.height != t &&
            ((i.height = t * o),
            (i.style.height = t + 'px'),
            (this.height = t)),
          ...
          if (d.call(e, t)) {
            ...
            for (var o in (i.hide(), n))
              if (d.call(n, o)) {
                ...
                for (var a in r)
                  if (d.call(r, a)) {
                    for (var l, s = r[a].positions, c = 0; (l = s[c]); c++)
                      l.active
                        ? l.rendered || (i.append(l.element), (l.rendered = !0))
                        : (s.splice(c--, 1), l.rendered && l.element.detach());
        ...
        return (
          null == t &&
            (null == this.textContainer &&
              (this.textContainer = Q("<div class='flot-text'></div>")
                .css({
                  position: 'absolute',
                  top: 0,
                  left: 0,
      ...
      (V.prototype.getTextInfo = function (e, t, i, n, o) {
        ...
        if (
          ...
          var c = Q('<div></div>')
            .html(t)
            .css({ position: 'absolute', 'max-width': o, top: -9999 })
            .appendTo(this.getTextLayer(e));
          'object' == typeof i
            ? c.css({ font: r, color: i.color })
            : 'string' == typeof i && c.addClass(i),
            (s = l[t] =
              {
          ...
          if (null != a)
            for (var l in a)
              if (d.call(a, l)) {
                ...
                for (var c in s)
                  if (d.call(s, c))
                    for (var h = s[c].positions, u = 0; (f = h[u]); u++)
                      f.active = !1;
              }
        } else {
          var f;
          for (
            h = this.getTextInfo(e, n, o, r).positions, u = 0;
            (f = h[u]);
            u++
          )
            f.x == t && f.y == i && (f.active = !1);
        }
      }),
      (Q.plot = function (e, t, i) {
        return new n(Q(e), t, i, Q.plot.plugins);
      }),
      (Q.plot.version = '0.8.3'),
      (Q.plot.plugins = []),
      (Q.fn.plot = function (e, t) {
        return this.each(function () {
          Q.plot(this, e, t);
        });
      });
    ...
    (u[g] = 200),
      ...
      (a.event.special[d] = {
        ...
        teardown: function () {
          ...
          e.removeData(p),
            h.length ||
              (f ? cancelAnimationFrame(c) : clearTimeout(c), (c = null));
        },
        add: function (e) {
          if (!u[o] && this[i]) return !1;
          var r;
      ...
      l.cancelAnimationFrame ||
        (l.cancelAnimationFrame =
          ...
          l.oCancelRequestAnimationFrame ||
          l.msCancelRequestAnimationFrame ||
          clearTimeout);
  })(jQuery, this),
      ...
      init: function (h) {
        ...
        function c(e) {
          if (0 < b.series.pie.innerRadius) {
            e.save();
            var t =
              1 < b.series.pie.innerRadius
                ? b.series.pie.innerRadius
                : u * b.series.pie.innerRadius;
            (e.globalCompositeOperation = 'destination-out'),
              e.beginPath(),
              (e.fillStyle = b.series.pie.stroke.color),
              ...
              e.save(),
              e.beginPath(),
              (e.strokeStyle = b.series.pie.stroke.color),
              e.arc(0, 0, t, 0, 2 * Math.PI, !1),
              e.stroke(),
              e.closePath(),
              e.restore();
        ...
        function p(e, t) {
          for (var i = !1, n = -1, o = e.length, r = o - 1; ++n < o; r = n)
            ((e[n][1] <= t[1] && t[1] < e[r][1]) ||
              (e[r][1] <= t[1] && t[1] < e[n][1])) &&
              t[0] <
                ((e[r][0] - e[n][0]) * (t[1] - e[n][1])) / (e[r][1] - e[n][1]) +
                  e[n][0] &&
              (i = !i);
          return i;
        }
        ...
        function t(e, t) {
                  ...
                  if (
                    ...
                    p(
                      [
                        [0, 0],
                        [
                          a * Math.cos(s.startAngle),
                          a * Math.sin(s.startAngle),
                        ],
                        [
                          a * Math.cos(s.startAngle + s.angle / 4),
                          a * Math.sin(s.startAngle + s.angle / 4),
                        ],
                        [
                          a * Math.cos(s.startAngle + s.angle / 2),
                          a * Math.sin(s.startAngle + s.angle / 2),
                        ],
                        [
                          a * Math.cos(s.startAngle + s.angle / 1.5),
                          a * Math.sin(s.startAngle + s.angle / 1.5),
                        ],
                        [
                          a * Math.cos(s.startAngle + s.angle),
                          a * Math.sin(s.startAngle + s.angle),
                        ],
                      ],
                      [i, n]
                    )
          ...
          a &&
            ...
            (n = e),
            -1 == (o = m(i))
              ? (d.push({ series: i, auto: n }), h.triggerRedrawOverlay())
              : n || (d[o].auto = !1));
        ...
        function g(e) {
          ...
          var t = m(e);
          -1 != t && (d.splice(t, 1), h.triggerRedrawOverlay());
        }
        function m(e) {
          for (var t = 0; t < d.length; ++t) if (d[t].series == e) return t;
          return -1;
        }
        h.hooks.processOptions.push(function (e, t) {
          ...
          h.hooks.bindEvents.push(function (e, t) {
            var i = e.getOptions();
            i.series.pie.show &&
              (i.grid.hoverable && t.unbind('mousemove').mousemove(n),
              i.grid.clickable && t.unbind('click').click(o));
          }),
                ...
                o.setData(
                  (function (e) {
                    for (
                      ...
                      var l = e[a].data;
                      w.isArray(l) && 1 == l.length && (l = l[0]),
                        w.isArray(l)
                          ? !isNaN(parseFloat(l[1])) && isFinite(l[1])
                            ? (l[1] = +l[1])
                            : (l[1] = 0)
                          : (l =
                              !isNaN(parseFloat(l)) && isFinite(l)
                                ? [1, +l]
                                : [1, 0]),
                        (e[a].data = [l]);
                    }
                    ...
                    for (var a = 0; a < e.length; ++a) {
                      var l = e[a].data[0][1];
                      l / t <= b.series.pie.combine.threshold &&
                        ((i += l), n++, o || (o = e[a].color));
                    }
                    for (var a = 0; a < e.length; ++a) {
                      var l = e[a].data[0][1];
                      (n < 2 || l / t > b.series.pie.combine.threshold) &&
                        r.push(
                          w.extend(e[a], {
                            data: [[1, l]],
                            color: e[a].color,
          ...
          h.hooks.drawOverlay.push(function (e, t) {
            e.getOptions().series.pie.show &&
              (function (e, t) {
                var i = e.getOptions(),
                  n =
                    1 < i.series.pie.radius
                      ? i.series.pie.radius
                      : u * i.series.pie.radius;
            ...
            e.getOptions().series.pie.show &&
              (function (e, t) {
                if (v) {
                  ...
                  (f = t),
                    (s = !1),
                    (u = Math.min(m, x / b.series.pie.tilt) / 2),
                    (y = x / 2 + b.series.pie.offset.top),
                    (k = m / 2),
                    'auto' == b.series.pie.offset.left
                      ? (b.legend.position.match('w')
                          ? (k += i / 2)
                          : (k -= i / 2),
                        k < u ? (k = u) : m - u < k && (k = m - u))
                      : (k += b.series.pie.offset.left);
                  for (
                    var a = e.getData(), n = 0;
                    0 < n && (u *= 0.95),
                      (n += 1),
                      o(),
                      b.series.pie.tilt <= 0.8 && r(),
                      !l() && n < 10;
                ...
                function r() {
                  var e = b.series.pie.shadow.left,
                    ...
                    n =
                      1 < b.series.pie.radius
                        ? b.series.pie.radius
                        : u * b.series.pie.radius;
                  if (
                    !(
                      m / 2 - e <= n ||
                      n * b.series.pie.tilt >= x / 2 - t ||
                      n <= 10
                    )
                  ) {
                    f.save(),
                      ...
                      (f.fillStyle = '#000'),
                      f.translate(k, y),
                      f.scale(1, b.series.pie.tilt);
                    for (var o = 1; o <= 10; o++)
                      f.beginPath(),
                        f.arc(0, 0, n, 0, 2 * Math.PI, !1),
                        f.fill(),
                        (n -= o);
                    f.restore();
                  }
                ...
                function l() {
                  ...
                  f.save(),
                    ...
                    f.scale(1, b.series.pie.tilt),
                    f.save();
                  for (var r = n, e = 0; e < a.length; ++e)
                    (a[e].startAngle = r), t(a[e].angle, a[e].color, !0);
                  if ((f.restore(), 0 < b.series.pie.stroke.width)) {
                    f.save(),
                      (f.lineWidth = b.series.pie.stroke.width),
                      (r = n);
                    for (var e = 0; e < a.length; ++e)
                      t(a[e].angle, b.series.pie.stroke.color, !1);
                    f.restore();
                  }
                  return (
                    c(f),
                    f.restore(),
                    !b.series.pie.label.show ||
                      (function () {
                        for (
                          var e = n,
                            g =
                          ...
                          if (
                            a[t].percent >=
                              100 * b.series.pie.label.threshold &&
                            !i(a[t], e, t)
                          )
                            return !1;
                          e += a[t].angle;
                        ...
                        function i(e, t, i) {
                          ...
                          var a = (t + e.angle + t) / 2,
                            ...
                            s =
                              y +
                              Math.round(Math.sin(a) * g) * b.series.pie.tilt,
                            c =
                          ...
                          if (0 != b.series.pie.label.background.opacity) {
                            ...
                            w(
                              ...
                              .css(
                                'opacity',
                                b.series.pie.label.background.opacity
                              )
                              .insertBefore(h);
                          }
                          return !0;
                  ...
                  function t(e, t, i) {
                    e <= 0 ||
                      ...
                      (i
                        ? (f.fillStyle = t)
                        : ((f.strokeStyle = t), (f.lineJoin = 'round')),
                      f.beginPath(),
                      1e-9 < Math.abs(e - 2 * Math.PI) && f.moveTo(0, 0),
                      f.arc(0, 0, o, r, r + e / 2, !1),
                      f.arc(0, 0, o, r + e / 2, r + e, !1),
                      f.closePath(),
                      (r += e),
                      i ? f.fill() : f.stroke());
                  }
    ...
    function t(e, t, i, n) {
      ...
      if (o || r) {
        ...
        for (var c = 0; c < a.length; ++c)
          a[c].x && o && (a[c].number = !1), a[c].y && r && (a[c].number = !1);
      }
    }
    function s(e) {
      var t = [];
    ...
    function n(e, t, i) {
      if ('categories' == e[t].options.mode) {
        if (!e[t].categories) {
          ...
          if (l.isArray(o)) for (var r = 0; r < o.length; ++r) n[o[r]] = r;
          else for (var a in o) n[a] = o[a];
          e[t].categories = n;
        }
  ...
  (function (i) {
    ...
    function n(e) {
      ...
      for (
        ...
        t(i, 'get' + n[o], e, 'getUTC' + n[o]),
          t(i, 'set' + n[o], e, 'setUTC' + n[o]);
      return i;
    }
    function b(e, t) {
            ...
            'time' == x.mode &&
              ((t.tickGenerator = function (e) {
                ...
                for (
                  ...
                  !(
                    e.delta <
                      (o[r][0] * k[o[r][1]] + o[r + 1][0] * k[o[r + 1][1]]) /
                        2 && o[r][0] * k[o[r][1]] >= n
                  );
                  ++r
                );
                var a = o[r][0],
                  l = o[r][1];
                if ('year' == l) {
                  if (null != x.minTickSize && 'year' == x.minTickSize[1])
                    a = Math.floor(x.minTickSize[0]);
                  else {
                    var s = Math.pow(
                        10,
                ...
                var u = h * k[l];
                'second' == l
                  ? i.setSeconds(v(i.getSeconds(), h))
                  : 'minute' == l
                  ? i.setMinutes(v(i.getMinutes(), h))
                  : 'hour' == l
                  ? i.setHours(v(i.getHours(), h))
                  : 'month' == l
                  ? i.setMonth(v(i.getMonth(), h))
                  : 'quarter' == l
                  ? i.setMonth(3 * v(i.getMonth() / 3, h))
                  : 'year' == l && i.setFullYear(v(i.getFullYear(), h)),
                  i.setMilliseconds(0),
                  k.minute <= u && i.setSeconds(0),
                  k.hour <= u && i.setMinutes(0),
                  k.day <= u && i.setHours(0),
                  4 * k.day <= u && i.setDate(1),
                  2 * k.month <= u && i.setMonth(v(i.getMonth(), 3)),
                  2 * k.quarter <= u && i.setMonth(v(i.getMonth(), 6)),
                ...
                do {
                  if (
                    ...
                    if (h < 1) {
                      ...
                      var m = i.getTime();
                      i.setTime(p + d * k.hour + (m - g) * h),
                        (d = i.getHours()),
                        i.setHours(0);
                    } else
                      i.setMonth(i.getMonth() + h * ('quarter' == l ? 3 : 1));
                  else
                    'year' == l
                      ? i.setFullYear(i.getFullYear() + h)
                      : i.setTime(p + u);
                } while (p < e.max && p != f);
                return t;
              }),
              (t.tickFormatter = function (e, t) {
                var i = b(e, t.options);
                if (null != x.timeformat)
                  return s(i, x.timeformat, x.monthNames, x.dayNames);
                var n =
                    (t.options.tickSize &&
