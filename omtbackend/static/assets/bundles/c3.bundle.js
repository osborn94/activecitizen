  ...
  return (
    ...
    (m.getTranslate = function (t) {
      ...
      return (
        'main' === t
          ...
          : 'y2' === t
          ? ((e = r.axis_rotated ? 0 : i.width), (n = r.axis_rotated ? 1 : 0))
          : 'subx' === t
          ? ((e = 0), (n = r.axis_rotated ? 0 : i.height2))
          : 'arc' === t && ((e = i.arcWidth / 2), (n = i.arcHeight / 2)),
        'translate(' + e + ',' + n + ')'
      );
    }),
        ...
        t.data
          ? i.isMultipleX()
            ? ((n = [i.x(t.data.x), i.getYScale(t.data.id)(t.data.value)]),
              (e = null))
            : (e = P(t.data.index) ? t.data.index : i.getIndexByX(t.data.x))
          : void 0 !== t.x
          ? (e = i.getIndexByX(t.x))
      ...
      return (
        t
          ? (t.x
            ...
            (n = a.convertRowsToData(o)))
          : (Object.keys(e).forEach(function (t) {
              o.push([t].concat(e[t]));
            }),
            (n = a.convertColumnsToData(o))),
        n
      );
    }),
    ...
    (m.loadFromArgs = function (e) {
      ...
      e.data
        ...
        : e.json
        ? n.load(n.convertDataToTargets(n.convertJsonToData(e.json, e.keys)), e)
        : e.rows
        ? n.load(n.convertDataToTargets(n.convertRowsToData(e.rows)), e)
        : e.columns
        ? n.load(n.convertDataToTargets(n.convertColumnsToData(e.columns)), e)
        : n.load(null, e);
    }),
    ...
    (m.getXDomain = function (t) {
      ...
      return (
        i - r != 0 ||
          e.isCategorized() ||
          (e.isTimeSeries()
            ? ((i = new Date(0.5 * i.getTime())),
              (r = new Date(1.5 * r.getTime())))
            : ((i = 0 === i ? 1 : 0.5 * i), (r = 0 === r ? -1 : 1.5 * r))),
        (i || 0 === i) &&
    ...
    (m.updateXDomain = function (t, e, n, i, r) {
      ...
      return (
        ...
        e &&
          (a.x.domain(
            r || (!a.brush || a.brush.empty() ? a.orgXDomain : a.brush.extent())
          ),
          o.zoom_enabled && a.zoom.scale(a.x).updateScaleExtent()),
    ...
    (m.redrawEventRect = function () {
      var t,
        ...
        a = n.main
          ...
          .style(
            'cursor',
            i.zoom_enabled ? (i.axis_rotated ? 'ns-resize' : 'ew-resize') : null
          )
    ...
    (m.generateDrawLine = function (t, s) {
      var u = this,
        c = u.config,
        l = u.d3.svg.line(),
        n = u.generateGetLinePoints(t, s),
        h = s ? u.getSubYScale : u.getYScale,
        e = function (t) {
          return (s ? u.subxx : u.xx).call(u, t);
        },
        i = function (t, e) {
          return 0 < c.data_groups.length
            ? n(t, e)[0][1]
            : h.call(u, t.id)(t.value);
        };
      return (
        (l = c.axis_rotated ? l.x(i).y(e) : l.x(e).y(i)),
        c.line_connectNull ||
          (l = l.defined(function (t) {
            return null != t.value;
          })),
        function (t) {
          var e,
            n = c.line_connectNull ? u.filterRemoveNull(t.values) : t.values,
            i = s ? u.x : u.subX,
            r = h.call(u, t.id),
            a = 0,
            o = 0;
          return (
            u.isLineType(t)
              ? c.data_regions[t.id]
                ...
                : (u.isStepType(t) && (n = u.convertValuesToStep(n)),
                  (e = l.interpolate(u.getInterpolate(t))(n)))
              : (n[0] && ((a = i(n[0].x)), (o = r(n[0].value))),
                (e = c.axis_rotated ? 'M ' + o + ' ' + a : 'M ' + a + ' ' + o)),
            e || 'M 0 0'
          );
        }
      );
    ...
    (m.generateDrawArea = function (t, e) {
      var a = this,
        o = a.config,
        s = a.d3.svg.area(),
        n = a.generateGetAreaPoints(t, e),
        i = e ? a.getSubYScale : a.getYScale,
        r = function (t) {
          return (e ? a.subxx : a.xx).call(a, t);
        },
        u = function (t, e) {
          return 0 < o.data_groups.length
            ? n(t, e)[0][1]
            : i.call(a, t.id)(a.getAreaBaseValue(t.id));
        },
        c = function (t, e) {
          return 0 < o.data_groups.length
            ? n(t, e)[1][1]
            : i.call(a, t.id)(t.value);
        };
      return (
        (s = o.axis_rotated
          ? s.x0(u).x1(c).y(r)
          : s
              ...
              .y1(c)),
        o.line_connectNull ||
          (s = s.defined(function (t) {
            return null !== t.value;
          })),
        function (t) {
          var e,
            n = o.line_connectNull ? a.filterRemoveNull(t.values) : t.values,
            i = 0,
            r = 0;
          return (
            a.isAreaType(t)
              ? (a.isStepType(t) && (n = a.convertValuesToStep(n)),
                (e = s.interpolate(a.getInterpolate(t))(n)))
              : (n[0] &&
                  ((i = a.x(n[0].x)), (r = a.getYScale(t.id)(n[0].value))),
                (e = o.axis_rotated ? 'M ' + r + ' ' + i : 'M ' + i + ' ' + r)),
            e || 'M 0 0'
          );
        }
      );
    ...
    (m.getXForText = function (t, e, n) {
      ...
      return (
        a.config.axis_rotated
          ? ((r = a.isBarType(e) ? 4 : 6),
            (i = t[2][1] + r * (e.value < 0 ? -1 : 1)))
          : (i = a.hasType('bar') ? (t[2][0] + t[0][0]) / 2 : t[0][0]),
        null === e.value &&
        ...
        function t(l, h, d, f, g) {
          return function () {
            var i,
              ...
              c = h(r, s);
            x
              ? (i = [(i = x.apply(this, arguments)).x - c[0], i.y - c[1]])
              : (i = [0, 0]),
              a({ type: 'dragstart' });
          };
        }
          ...
          function (t) {
            ...
            return function (t) {
              ...
              if (o < 0) {
                ...
                s < 0
                  ? ((r = t), (a = ''))
                  : ((r = t.substring(0, s)), (a = t.substring(s)));
