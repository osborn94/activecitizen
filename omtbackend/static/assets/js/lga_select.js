const localGovernments = {
    "Abia": [
        ...
        "Ugwunagbo", "Ukwa East", "Ukwa West", "Umuahia North", "Umuahia South", "Umu-Neochi"
    ],
    "Adamawa": [
    ...
    "Bauchi": [
        "Alkaleri", "Bauchi", "Bogoro", "Damban", "Darazo", "Dass", "Ganjuwa", "Giade", 
    ...
    "Cross River": [
        "Akpabuyo", "Odukpani", "Akamkpa", "Biase", "Abi", "Ikom", "Yarkur", "Odubra", 
        "Boki", "Ogoja", "Yala", "Obanliku", "Obudu", "Calabar South", "Etung", "Bekwara", 
        "Bakassi", "Calabar Municipality"
    ],
    "Delta": [
        "Oshimili", "Aniocha", "Aniocha South", "Ika South", "Ika North-East", "Ndokwa West", 
        "Ndokwa East", "Isoko south", "Isoko North", "Bomadi", "Burutu", "Ughelli South", 
        "Ughelli North", "Ethiope West", "Ethiope East", "Sapele", "Okpe", "Warri North", 
        "Warri South", "Uvwie", "Udu", "Warri Central", "Ukwani", "Oshimili North", "Patani"
    ],
    "Ebonyi": [
        "Afikpo South", "Afikpo North", "Onicha", "Ohaozara", "Abakaliki", "Ishielu", "Ikwo", 
        "Ezza", "Ezza South", "Ohaukwu", "Ebonyi", "Ivo"
    ],
    "Enugu": [
        "Enugu South", "Igbo-Eze South", "Enugu North", "Nkanu", "Udi Agwu", "Oji-River", 
        "Ezeagu", "IgboEze North", "Isi-Uzo", "Nsukka", "Igbo-Ekiti", "Uzo-Uwani", 
        "Enugu East", "Aninri", "Nkanu East", "Udenu"
    ],
    "Edo": [
        "Esan North-East", "Esan Central", "Esan West", "Egor", "Ukpoba", "Central", "Etsako Central", 
        "Igueben", "Oredo", "Ovia South-West", "Ovia South-East", "Orhionwon", "Uhunmwonde", 
        "Etsako East", "Esan South-East"
    ],
    "Ekiti": [
        "Ado", "Ekiti-East", "Ekiti-West", "Emure/Ise/Orun", "Ekiti South-West", "Ikare", 
        "Irepodun", "Ijero", "Ido/Osi", "Oye", "Ikole", "Moba", "Gbonyin", "Efon", "Ise/Orun", 
        "Ilejemeje"
    ],
    "Abuja": [
    ...
    "Imo": [
        ...
        "Nwangele", "Nkwerre", "Obowo", "Oguta", "Ohaji/Egbema", "Okigwe", "Orlu", "Orsu", 
        "Oru West", "Oru", "Owerri", "Owerri North", "Owerri South"
    ],
    "Jigawa": [
        "Auyo", "Babura", "Birni Kudu", "Biriniwa", "Buji", "Dutse", "Gagarawa", "Garki", 
        "Gumel", "Guri", "Gwaram", "Gwiwa", "Hadejia", "Jahun", "Kafin Hausa", "Kaugama", 
        "Kazaure", "Kiri Kasamma", "Kiyawa", "Maigatari", "Malam Madori", "Miga", "Ringim", 
    ...
    "Kano": [
        ...
        "Rimin Gado", "Rogo", "Shanono", "Sumaila", "Takali", "Tarauni", "Tofa", "Tsanyawa", 
    ...
    "Niger": [
        "Agaie", "Agwara", "Bida", "Borgu", "Bosso", "Chanchanga", "Edati", "Gbako", 
    ...
    "Ondo": [
        ...
        "Akure North", "Akure South", "Ese-Odo", "Idanre", "Ifedore", "Ilaje", "Ile-Oluji", 
        "Okeigbo", "Irele", "Odigbo", "Okitipupa", "Ondo", "Ondo East", "Ose", "Owo"
    ],
    "Osun": [
    ...
    "Oyo": [
        "Afijio", "Akinyele", "Atiba", "Atigbo", "Egbeda", "Ibadan Central", "Ibadan North-East", 
        "Ibadan South-East", "Ibadan West South", "Ibarapa Central", "Ibarapa East", "Ibarapa North", 
        "Ido", "Ifedapo", "Ifeloju", "Irepo", "Iseyin", "Itesiwaju", "Iwajowa", "Kajola", 
        "Lagelu", "Ogbomosho North", "Ogbomosho South", "Ogo Oluwa", "Olorunsogo", "Oluyole", 
        "Ona-Ara", "Orelope", "Orire", "Oyo East", "Oyo West", "Saki East", "Saki West", 
        "Surulere"
    ],
    "Plateau": [
    ...
    "Sokoto": [
        "Binji", "Bodinga", "Dange-shnsi", "Gada", "Goronyo", "Gudu", "Gwadabawa", 
        "Illela", "Kebbe", "Kware", "Rabah", "Sabon birni", "Shagari", "Silame", "Sokoto North", 
        "Sokoto South", "Tambuwal", "Tqngaza", "Tureta", "Wamako", "Wurno", "Yabo"
    ],
    "Taraba": [
        "Ardo-kola", "Bali", "Donga", "Gashaka", "Cassol", "Ibi", "Jalingo", "K/Lamido", 
        "Kurmi", "Lan", "Yoro", "Karim-Lamido", "Lau", "Sardauna", "Takum", "Ussa", 
        "Wukari", "Zing"
    ],
    "Yobe": [
    ...
    "Zamfara": [
        "Anka", "Bakura", "Birnin Magaji", "Bukkuyum", "Bungudu", "Gummi", "Gusau", 
        "Kaura", "Namoda", "Maradun", "Maru", "Shinkafi", "Talata Mafara", "Tsafe", 
        "Zurmi"
    ]
};

function updateLocalGovernments(selectedState) {
    ...
    if (selectedState && localGovernments[selectedState]) {
        localGovernments[selectedState].forEach(lga => {
