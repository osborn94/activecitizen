          ...
          s = {
            ...
            then: function (t, n, i) {
                    ...
                    e = function () {
                      ...
                      if (!(r < l)) {
                        ...
                        (t =
                          ...
                          y(t)
                            ? a
                              ? t.call(e, u(l, o, P, a), u(l, o, q, a))
                              : (l++,
                                t.call(
                                  e,
                                  u(l, o, P, a),
                                  u(l, o, q, a),
                                  u(l, o, P, o.notifyWith)
                                ))
                            : (s !== P && ((n = void 0), (i = [e])),
                              (a || o.resolveWith)(n, i));
                      }
              ...
              return C.Deferred(function (e) {
                o[0][3].add(u(0, e, y(i) ? i : P, e.notifyWith)),
                  o[1][3].add(u(0, e, y(t) ? t : P)),
        ...
        if (
          ...
          try {
            (i.href = m.url),
              (i.href = i.href),
              (m.crossDomain =
                Pt.protocol + '//' + Pt.host != i.protocol + '//' + i.host);
          } catch (e) {
            m.crossDomain = !0;
          }
        }
  ...
  C.ajaxSetup({
    ...
    C.each(['top', 'left'], function (e, n) {
      C.cssHooks[n] = Fe(v.pixelPosition, function (e, t) {
        if (t)
          return (t = Me(e, n)), Pe.test(t) ? C(e).position()[n] + 'px' : t;
      });
    }),
  ...
  (function (e, t) {
    ...
    p(document)
      ...
      (p.fn[f].noConflict = function () {
        return (p.fn[f] = v), w._jQueryInterface;
      });
    var E = 'carousel',
      T = 'bs.carousel',
      x = '.' + T,
      ...
      k = {
        ...
        LOAD_DATA_API: 'load' + x + C,
        CLICK_DATA_API: 'click' + x + C,
      },
      O = 'active',
      ...
      H = (function () {
        ...
        return (
          ...
          (e._getConfig = function (e) {
            return (e = l({}, D, e)), g.typeCheckConfig(E, e, A), e;
          }),
          ...
          (o._jQueryInterface = function (i) {
            return this.each(function () {
              ...
              if (
                (e || ((e = new o(this, t)), p(this).data(T, e)),
                'number' == typeof i)
              )
                e.to(i);
    ...
    p(document).on(
      ...
      (p.fn[E] = H._jQueryInterface),
      (p.fn[E].Constructor = H),
      (p.fn[E].noConflict = function () {
        return (p.fn[E] = S), H._jQueryInterface;
      });
    var P = 'collapse',
      q = 'bs.collapse',
      R = '.' + q,
            ...
            if (
              !(
                ...
                (this._parent &&
                  ...
                  (e = null),
                e &&
                  (t = p(e).not(this._selector).data(q)) &&
                  t._isTransitioning)
              )
            ) {
              ...
              if ((p(this._element).trigger(i), !i.isDefaultPrevented())) {
                ...
                p(this._element).removeClass(K).addClass($),
                ...
                p(this._element)
                  .one(g.TRANSITION_END, function () {
                    p(n._element).removeClass($).addClass(K).addClass(U),
                      (n._element.style[r] = ''),
            ...
            if (!this._isTransitioning && p(this._element).hasClass(U)) {
              ...
              if ((p(this._element).trigger(t), !t.isDefaultPrevented())) {
                ...
                (this._element.style[n] =
                  ...
                  p(this._element).addClass($).removeClass(K).removeClass(U);
                  ...
                  for (var r = 0; r < i; r++) {
                    ...
                    null !== s &&
                      (p([].slice.call(document.querySelectorAll(s))).hasClass(
                        ...
                        p(o).addClass(Q).attr('aria-expanded', !1));
                  }
    ...
    p(document).on(B.CLICK_DATA_API, V, function (e) {
      ...
      (p.fn[P] = z._jQueryInterface),
      (p.fn[P].Constructor = z),
      (p.fn[P].noConflict = function () {
        return (p.fn[P] = M), z._jQueryInterface;
      });
    for (
      ...
      if (Y && 0 <= navigator.userAgent.indexOf(X[J])) {
        G = 1;
        break;
      }
    var Z =
    ...
    var re = Y && !(!window.MSInputMethodContext || !document.documentMode),
      oe = Y && /MSIE 10/.test(navigator.userAgent);
    function se(e) {
    ...
    function de(e) {
      ...
      return { height: he('Height', t, n, i), width: he('Width', t, n, i) };
    }
    var pe = (function () {
        function i(e, t) {
          for (var n = 0; n < t.length; n++) {
    ...
    var je = Y && /Firefox/i.test(navigator.userAgent);
    function He(e, t, n) {
      var i = De(e, function (e) {
          return e.name === t;
        }),
              ...
              return (
                b.forEach(function (e, t) {
                  ...
                  (s || f || d) &&
                    ...
                    (p = Ae(p.instance.modifiers, p, 'flip')));
                }),
                p
              );
            },
          ...
          hide: {
            ...
            fn: function (e) {
              ...
              var t = e.offsets.reference,
                n = De(e.instance.modifiers, function (e) {
          ...
          computeStyle: {
            ...
            fn: function (e, t) {
              var n = t.x,
                i = t.y,
                r = e.offsets.popper,
                o = De(e.instance.modifiers, function (e) {
              ...
              var s,
                ...
                b,
                w,
                E = void 0 !== o ? o : t.gpuAcceleration,
                T = ae(e.instance.popper),
                x = ye(T),
    ...
    var We = 'dropdown',
      ...
      Ve = {
        ...
        SHOWN: 'shown' + Ue,
        CLICK: 'click' + Ue,
        CLICK_DATA_API: 'click' + Ue + Ke,
        KEYDOWN_DATA_API: 'keydown' + Ue + Ke,
        KEYUP_DATA_API: 'keyup' + Ue + Ke,
      },
      ze = 'disabled',
      Ye = 'show',
      ...
      tt = (function () {
        ...
        return (
              ...
              if ((u._clearMenus(), !t)) {
                ...
                if ((p(e).trigger(i), !i.isDefaultPrevented())) {
                  ...
                  'ontouchstart' in document.documentElement &&
                    ...
                    p(this._menu).toggleClass(Ye),
                    p(e).toggleClass(Ye).trigger(p.Event(Ve.SHOWN, n));
                }
              }
            }
          }),
            ...
            if (
              ...
              p(n).trigger(t),
                t.isDefaultPrevented() ||
                  (p(this._menu).toggleClass(Ye),
                  p(n).toggleClass(Ye).trigger(p.Event(Ve.SHOWN, e)));
            }
          }),
          (e.hide = function () {
            if (
              ...
              p(n).trigger(t),
                t.isDefaultPrevented() ||
                  (p(this._menu).toggleClass(Ye),
                  p(n).toggleClass(Ye).trigger(p.Event(Ve.HIDDEN, e)));
            }
          }),
          (e.dispose = function () {
          ...
          (e._addEventListeners = function () {
            var t = this;
            p(this._element).on(Ve.CLICK, function (e) {
          ...
          (e._getPlacement = function () {
            ...
            return (
              e.hasClass('dropup')
                ? ((t = 'top-start'),
                  p(this._menu).hasClass(Xe) && (t = 'top-end'))
                : e.hasClass('dropright')
                ? (t = 'right-start')
                : e.hasClass('dropleft')
                ? (t = 'left-start')
                : p(this._menu).hasClass(Xe) && (t = 'bottom-end'),
              t
            );
          }),
                  ...
                  if (
                    ...
                    p(r).trigger(l),
                      l.isDefaultPrevented() ||
                        ...
                        p(a).removeClass(Ye),
                        p(r).removeClass(Ye).trigger(p.Event(Ve.HIDDEN, s)));
                  }
                }
              }
          }),
    ...
    p(document)
      .on(Ve.KEYDOWN_DATA_API, Ge, tt._dataApiKeydownHandler)
      .on(Ve.KEYDOWN_DATA_API, Je, tt._dataApiKeydownHandler)
      .on(Ve.CLICK_DATA_API + ' ' + Ve.KEYUP_DATA_API, tt._clearMenus)
      .on(Ve.CLICK_DATA_API, Ge, function (e) {
        e.preventDefault(),
          e.stopPropagation(),
      ...
      (p.fn[We] = tt._jQueryInterface),
      (p.fn[We].Constructor = tt),
      (p.fn[We].noConflict = function () {
        return (p.fn[We] = $e), tt._jQueryInterface;
      });
    var nt = 'modal',
      it = 'bs.modal',
      rt = '.' + it,
            ...
            if (
              ...
              if (
                ...
                if (
                  ...
                  p(this._element).removeClass(ft),
          ...
          (e.show = function () {
            ...
            if (this.isWithContent() && this._isEnabled) {
              ...
              p(r).data(this.constructor.DATA_KEY, this),
                ...
                (this._popper = new Fe(this.element, r, {
                  placement: a,
                  modifiers: {
                    offset: this._getOffset(),
    ...
    (p.fn[_t] = Ht._jQueryInterface),
      (p.fn[_t].Constructor = Ht),
      (p.fn[_t].noConflict = function () {
        return (p.fn[_t] = Et), Ht._jQueryInterface;
      });
    var Pt = 'popover',
      qt = 'bs.popover',
      Rt = '.' + qt,
      ...
      Ut = l({}, Ht.DefaultType, { content: '(string|element|function)' }),
      Kt = {
        HIDE: 'hide' + Rt,
        HIDDEN: 'hidden' + Rt,
        SHOW: 'show' + Rt,
        ...
        return (
          ...
          (i._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                (e || !/dispose|hide/.test(n)) &&
                (e || ((e = new i(this, t)), p(this).data(qt, e)),
                'string' == typeof n)
              ) {
                if (void 0 === e[n])
                  throw new TypeError('No method named "' + n + '"');
    ...
    (p.fn[Pt] = $t._jQueryInterface),
      (p.fn[Pt].Constructor = $t),
      (p.fn[Pt].noConflict = function () {
        return (p.fn[Pt] = Mt), $t._jQueryInterface;
      });
    var Qt = 'scrollspy',
      Vt = 'bs.scrollspy',
      zt = '.' + Vt,
      Yt = p.fn[Qt],
      Xt = { offset: 10, method: 'auto', target: '' },
      ...
      on = (function () {
        ...
        return (
          ...
          (e.dispose = function () {
            p.removeData(this._element, Vt),
              p(this._scrollElement).off(zt),
              (this._element = null),
          ...
          (e._getConfig = function (e) {
            if (
              'string' !=
              typeof (e = l({}, Xt, 'object' == typeof e && e ? e : {})).target
            ) {
              var t = p(e.target).attr('id');
              t || ((t = g.getUID(Qt)), p(e.target).attr('id', t)),
                (e.target = '#' + t);
            }
            return g.typeCheckConfig(Qt, e, Gt), e;
          }),
    ...
    p(window).on(Jt.LOAD_DATA_API, function () {
      ...
      (p.fn[Qt] = on._jQueryInterface),
      (p.fn[Qt].Constructor = on),
      (p.fn[Qt].noConflict = function () {
        return (p.fn[Qt] = Yt), on._jQueryInterface;
      });
    var sn = 'bs.tab',
      an = '.' + sn,
      ln = p.fn.tab,
        ...
        return (
          (e.show = function () {
            ...
            if (
              ...
              if (t) {
                var o = 'UL' === t.nodeName || 'OL' === t.nodeName ? hn : fn;
    ...
    var pn = 'toast',
      ...
      En = { animation: !0, autohide: !0, delay: 500 },
      Tn = (function () {
        function i(e, t) {
          (this._element = e),
            (this._config = this._getConfig(t)),
    ...
    (p.fn[pn] = Tn._jQueryInterface),
      (p.fn[pn].Constructor = Tn),
      (p.fn[pn].noConflict = function () {
        return (p.fn[pn] = vn), Tn._jQueryInterface;
      }),
      (function () {
        if (void 0 === p)
          throw new TypeError(
